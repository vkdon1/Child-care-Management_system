...
<body>
	<div class="container mt-4 mb-3">
		...
		<hr>
			...
			<p>View Babysitter Information & Message with Babysitter.</p>
<br>
			...
			foreach( $object1 as $row ) {
				...
				if($object2->rowCount()==1){
					foreach( $object2 as $row2 ) {
						...
						<thead>
						  <tr>
						  <th width="20%">Babysitter ID</th>
							<th width="40%">Babysitter Name</th>
							<th width="40%">Babysitter Email Id</th>
					   ...
					   <form action="customer_babysiter/msg.php" method="post">
						  <h7> <input type="submit" value= "Message to '.$fname.' '. $lname.'"></h7>
