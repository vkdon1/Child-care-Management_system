...
<body>
	<div class="container mt-4 mb-3">
		...
		<hr>
			...
			<p>Select the customer below to view the infomation of the selected parents.</p>
	...
	<?php
					...
					foreach( $object2 as $row2 ) {
						...
						<thead>
						  ...
						  <th scope="col">'.$profile_id.'</th>
						   <th scope="col">'.$fname.' '.$lname.'</th>
							...
							<th scope="col">'.$postal_code.' Salary</th>
						...
						<tr><td><div class="show-result"> 
						 	<form action="customer_profile_info.php" method="post">
			                	<h6> <input type="submit" value= "View Request"></h6>
		...
		?>
		<center><a href = "babysiter.php" style="font-size: 1rem "> Back to Home</center>
	</div>
</body>
</html>